...
const AboutWhoWeAre = ({ isActive, isDark }) => {
  ...
  const images = [
    "https://res.cloudinary.com/dof2wtgd6/image/upload/v1760831421/U63A7356_xtd0q3.jpg",
    "https://res.cloudinary.com/dof2wtgd6/image/upload/v1760831420/559A7873_ztd1co.jpg",
    "https://res.cloudinary.com/dof2wtgd6/image/upload/v1760831419/U63A7348_emfgyj.jpg",
    "https://res.cloudinary.com/dof2wtgd6/image/upload/v1760831418/U63A7312_ekn7xq.jpg",
    "https://res.cloudinary.com/dof2wtgd6/image/upload/v1760831417/559A7920_msrfzv.jpg",
    "https://res.cloudinary.com/dof2wtgd6/image/upload/v1760831414/559A5680_pbt5pc.jpg",
  ];
          ...
          <div className="w-full h-full max-w-7xl mx-auto flex flex-col justify-center">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="space-y-6 flex flex-col justify-center h-full">
                ...
                >
                  <span className="text-xs sm:text-sm font-bold uppercase tracking-widest text-[#40916c]">
                    About Imfuyo
                  </span>
                  <h2
