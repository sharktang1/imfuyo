...
export default function Services({ parallaxOffset, isDark }) {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="relative z-20 flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden py-20">
